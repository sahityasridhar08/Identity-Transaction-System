...
<?php
	...
	$sql="insert into stores(id,no,activity,price) values($id,$iid,'$bname',$amt)";
	if($valid==true){
...
<div class="element-number"><label class="title">Enter Activity ID</label><div class="item-cont"><input id="no_chldren" class="large" type="number" min="0" max="100" name="bid" placeholder="Activity ID" value="<?php echo $iid?>" /><span class="icon-place"></span></div></div>
